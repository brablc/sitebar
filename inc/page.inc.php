...
class SB_HookInterface extends SB_ErrorHandler
{
    ...
    public function poweredBy($version, &$um)
    {
        ?>
    <div id='poweredBy'>
        <?php
    ...
    public function foot($version, $statistics, &$um)
    {
...
class SB_SponsorInterface
{
    ...
    public function integratorVerticalRight()
    {
    }

    public function buildAddLink()
    {
        return '';
    }

    public function sitebarBottom()
    {
    }
}
...
<body class="siteBar siteBarBaseFont siteBarPageBackground <?php echo $bodyClass?>" <?php echo ($onLoad ? ' onLoad="' . $onLoad . '"' : '')?> onmouseup="SB_cancelDragging();">
    ...
    public static function headerContent($inscript)
    {
        ?>
