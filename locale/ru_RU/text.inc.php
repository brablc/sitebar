...
Расширение для синхронизации закладок
_P;
...
Фильтр группы RegExp
_P;

$text['Filter User RegExp'] = <<<_P
Фильтр пользователя RegExp
_P;
...
Отправить E-mail всем
_P;

$text['Send Email to Members'] = <<<_P
Отправить E-mail to Members
_P;

$text['Send Email to Moderators'] = <<<_P
Отправить E-mail модераторам
_P;

$text['Send Email to User'] = <<<_P
Отправить E-mail пользователям
_P;
...
Добавить участника, используя Имя Пользователя
_P;

$text['Add SiteBar Commands'] = <<<_P
Добавить команды SiteBar
_P;

$text['Allow Anonymous Contact'] = <<<_P
Разрешить анонимные контакты
_P;

$text['Allow Anonymous Exports'] = <<<_P
Разрешить анонимный экспорт
_P;
...
Разрешить свой поисковик
_P;

$text['Allow Given Membership'] = <<<_P
Разрешить этих участников
_P;

$text['Allow Info Mail'] = <<<_P
Разрешить информационные E-mail
_P;
...
E-Mail RegExp для авто-регистрации
_P;
...
Скрыть расширенное управление
_P;

$text['Hide XSLT Features'] = <<<_P
Скрыть поддержку XSLT
_P;

$text['Ignore Private Bookmarks'] = <<<_P
Игнорировать личные ссылки
_P;

$text['Ignore Recently Tested'] = <<<_P
Игнорировать уже проверенные
_P;
...
Загружать личные ссылки только через SSL
_P;
...
Разрешить прием информационных E-mail
_P;
...
Показать результаты веб-поиска в потоке
_P;
...
Использовать перекодирование
_P;

$text['Use E-mail Features'] = <<<_P
Использовать возможности E-mail
_P;
...
Пользователи должны проверяться по E-mail
_P;
...
Ошибка при проверке версии!
_P;

$text['Will try in %d hours again.'] = <<<_P
Через %d часов повтор.
_P;
...
Порядок вывода папок или ссылок
_P;
...
SiteBar: E-mail всем пользователям
_P;

$text['SiteBar: Email to Group Members'] = <<<_P
SiteBar: E-mail пользователям группы
_P;

$text['SiteBar: Email to Group Moderators'] = <<<_P
SiteBar: E-mail модераторам группы
_P;

$text['SiteBar: Email to SiteBar User'] = <<<_P
SiteBar: E-mail пользователю SiteBar
_P;

$text['SiteBar: Email Verification'] = <<<_P
SiteBar: Проверка E-mail
_P;
...
Закладки из SiteBar установленного
_P;
...
Плагин аутентификации %s отсутствует!
_P;
...
Невозможно удалить пользователя, т.к. он единственный модератор групп(ы): %s!
_P;

$text['Cannot download %s using https, will try http!'] = <<<_P
Невозможно загрузить %s через https, пытаюсь  через http!
_P;
...
Узел %s содержит ACL запись, но ее нет!
_P;
...
Пожалуйста, кликните по ссылке внизу, чтобы отправить email!
_P;
...
Такой e-mail уже используется. Попытайтесь авторизоваться используя этот e-mail!
_P;
...
Для использования некоторых функций требуется проверка и подтверждение E-mail.
_P;
...
Пользователь "%s" еще не подтвердил e-mail "%s"!
_P;
...
Пользователь с e-mail "%s" не существует!
_P;

$text['User with username"%s" does not exist!'] = <<<_P
Пользователя с именем "%s" не существует!
_P;

$text['User with username "%s" has already been rejected!'] = <<<_P
Пользователь с именем "%s" уже отклонен!
_P;
...
Вы единственный модератор групп(ы): %s. Аккаунт не может быть удален!
_P;
...
Отсутствует механизм конвертации из кодировки %s!
_P;
