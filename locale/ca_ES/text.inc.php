...
$text['Feed Bookmark'] = <<<_P
Adreça d'interes del canal
_P;
...
Marcar com predeterminat
_P;

$text['Modify User Settings'] = <<<_P
Modificar configuració d'usuari
_P;
...
Envia missatge als grups
_P;

$text['Send Message to Members'] = <<<_P
Envia missatge als membres
_P;

$text['Send Message to User'] = <<<_P
Envia missatge a l'usuari
_P;
...
$text['Decorate Shared Folders'] = <<<_P
Decora les carpetes compartides
_P;
...
$text['Load All Folders'] = <<<_P
Carrega totes les carpetes
_P;
...
$text['Pop-up Window Parameters'] = <<<_P
Paràmetres de la finestra emergent
_P;
...
$text['Send E-mail about Deletion'] = <<<_P
Envia correu quant a l'eliminació
_P;
...
$text['Sharing List'] = <<<_P
Llista de comparticions
_P;

$text['Show Advanced Controls'] = <<<_P
Mostra controls avançats
_P;
...
Agents d'usuari per la cerca web
_P;
...
Interval de la comprovació de versió
_P;
...
Error durant la comprovació de versió!
_P;

$text['Will try in %d hours again.'] = <<<_P
Es reintentarà en %d hores.
_P;

$text['New version available'] = <<<_P
Una nova versió és disponible.
_P;
...
$text['Send message to group owner'] = <<<_P
Envia missatge al propietari del grup
_P;

$text['To (Just Label)'] = <<<_P
A
_P;
...
$text['Current User'] = <<<_P
Usuari actual
_P;

$text['Group Moderator'] = <<<_P
Moderador del grup
_P;

$text['Members of %s Group'] = <<<_P
Membres del grup %s
_P;

$text['Moderator of %s Group'] = <<<_P
Moderador del grup %s
_P;

$text['Moderators of %s Group'] = <<<_P
Moderadors del grup %s
_P;
...
$text['Messages from SiteBar installation at'] = <<<_P
Missatge de la instal·lació de SiteBar en:
_P;
...
$text['Sent to %s recipients.'] = <<<_P
Envia als %s destinataris.
_P;
...
$text['Toggle Selection'] = <<<_P
Commuta selecció
_P;

$text['You have a new message!'] = <<<_P
Teniu un missatge nou!
_P;
...
$text['Cannot connect to database!'] = <<<_P
...
$text['Cannot delete administrators group!'] = <<<_P
No es pot eliminat el grup d'administradors!
_P;
...
$text['Cannot open file %s. Does your HTTP server have write access to inc directory?'] = <<<_P
No es pot obrir el fitxer %s. Té el vostre servidor HTTP accés d'escriptura al directori inc?
_P;

$text['Cannot send verification email!'] = <<<_P
No es pot enviar correu de verificació
_P;
...
$text['Database already exists!'] = <<<_P
...
$text['Group name must not contain following characters [%s]!'] = <<<_P
El nom del grup no pot contenir sle caràcters següents [%s]!
_P;
...
La mida d'icona %s excedeix la mida màxima %s.
_P;
...
$text['Member that can invite, mark as contributor or remove other members.'] = <<<_P
Membre que pot invitar, marcar com a col·laborador o eliminar altres membres.
_P;

$text['Member that can share their folders with this group.'] = <<<_P
Membre que pot compartir les seves carpetes amb aquest grup.
_P;
...
$text['No feed available!'] = <<<_P
No hi ha cap canal disponible!
_P;

$text['No groups to join!'] = <<<_P
No hi ha groups als quals unir-se!
_P;
...
S'ha d'omplir un dels dos camps!
_P;
...
$text['Password incorrectly retyped!'] = <<<_P
Contrasenya repetida incorrectament!
_P;
...
Si us plau, feu clic en l'enllaç presentat a sota per enviar el correu!
_P;

$text['Please fill mandatory fields!'] = <<<_P
Si us play, ompliu els camps obligatoris!
_P;

$text['Please note your last steps and contanct SiteBar development!'] = <<<_P
Si us plau, preneu nota dels vostres darrers pasos i contacteu els desenvolupadors de SiteBar!
_P;

$text['Please override designedBy for your custom skins!'] = <<<_P
Si us plau, substituiu designedBy per les vostres pròpies aparences!
_P;
...
$text['The user %s is not a member!'] = <<<_P
L'suari %s no és un membre!
_P;
...
$text['This email is already used, select another one!'] = <<<_P
Aquesta adreça de correu ja és usada, si us plau, seleccioneu-ne una altra!
_P;

$text['This operation would lead to broken database.'] = <<<_P
Aquesta operació duria a una base de dades no vàlida.
_P;

$text['This username is already used, select another one!'] = <<<_P
Aquest nom d'usuari ja és usat, si us plau, seleccioneu-ne un altre!
_P;

$text['This username is already used. Did you forget your password?'] = <<<_P
Aquest nom d'usuari ja és usat. Heu oblidat la vostra contrasenya?
_P;
...
$text['User "%s" did not verify own email "%s" yet, he cannot be approved!'] = <<<_P
L'usuari "%s" encara no ha verificat la seva adreça de correu "%", no pot ser autoritzat!
_P;

$text['User %s approved.'] = <<<_P
L'usuari %s ha estat autoritzat
_P;

$text['User %s has already been approved!'] = <<<_P
L'usuari %s ja ha estat autoritzat
_P;
...
No existeix l'usuari "%s"!
_P;

$text['User with username "%s" has already been rejected!'] = <<<_P
L'usuari "%s" ha estat rebutjat!
_P;

$text['Username must not contain characters %s!'] = <<<_P
El nom d'usuari no ha de contenir els caràcters %s!
_P;
...
$text['XML error: %s at line %d col %d'] = <<<_P
Error d'XML: %s a la línia %d columna %d
_P;

$text['You have %d new messages!'] = <<<_P
Teniu %d missatges nous!
_P;
...
$text['E-mail %s verified!'] = <<<_P
L'adreça de correu %s ha estat verificada!
_P;
