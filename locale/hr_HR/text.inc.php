...
Uredi korisnikova članstva
_P;

$text['Modify User Settings'] = <<<_P
Uredi korisnikove postavke
_P;
...
Pošalji poruku članovima
_P;

$text['Send Message to Moderators'] = <<<_P
Pošalji poruku moderatorima
_P;
...
Pridruži prilikom registracije
_P;
...
Greška prilikom provjere verzije!
_P;

$text['Will try in %d hours again.'] = <<<_P
Novi pokušaj za %d sat(a).
_P;
...
Poruka sa SiteBar instalacije na
_P;
