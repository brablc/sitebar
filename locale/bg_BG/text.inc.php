...
Сървър съхраняващ отметки, за лична и колективна употреба
_P;
...
Добавяне на връзка в SiteBar
_P;

$text['Add Page to SiteBar'] = <<<_P
Добавяне на страница в SiteBar
_P;
...
Полезни съвети за всички браузъри
_P;
...
SiteBar - резултати от търсенето
_P;
...
Продължаване с уеб-търсенето...
_P;

$text['Web Search Results'] = <<<_P
Резултати от уеб-търсенето
_P;
