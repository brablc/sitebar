...
Changer statut membre
_P;

$text['Change Invitee Status'] = <<<_P
Changer statut invité
_P;
...
Envoyer un message aux groupes
_P;
...
Ouvrir liens dans nouvelle fenêtre
_P;
...
Informer des suppressions par email 
_P;
...
Envoyer un message au propriétaire du groupe
_P;
...
Modérateur du groupe %s
_P;

$text['Moderators of %s Group'] = <<<_P
Modérateurs du Groupe %s
_P;
...
Messages du serveur SiteBar sur
_P;
...
Impossible de supprimer le group des administrateurs!
_P;
...
Impossible d'ouvrir le fichier %s. Vérifiez les droits d'écriture sur le dossier inc pour votre serveur HTTP!
_P;
...
Le nom du groupe ne doit pas contenir les caractères suivants [%s]!
_P;
...
La taille de l'icône %s dépasse la taille limite de %s.
_P;
...
Membre pouvant inviter, marquer comme contributeur ou supprimer d'autres membres.
_P;

$text['Member that can share their folders with this group.'] = <<<_P
Membre qui peut partager ses dossiers avec ce groupe.
_P;
...
Veuillez prendre note de vos dernières actions et contacter l'équipe de développement de SiteBar!
_P;

$text['Please override designedBy for your custom skins!'] = <<<_P
Veuillez modifier designedBy pour vos thèmes personnalisés!
_P;
...
L'utilisateur %s n'est pas un membre!
_P;
...
Cette opération pourrait corrompre la base de données.
_P;
...
Ce nom d'utilisateur est déjà utilisé. Avez-vous oublié votre mot de passe?
_P;
...
L'utilisateur "%s" n'a pas encore vérifié son adresse email "%s", il ne peut pas être approuvé!
_P;

$text['User %s approved.'] = <<<_P
Utilisateur %s approuvé.
_P;
...
Le nom d'utilisateur ne doit pas contenir les caractères %s!
_P;
...
Erreur XML: %s à la ligne %d col %d
_P;
