...
Welkommen til SiteBar integrations siden. Denne side hjælper dig til at få mere ud af SiteBar. På <a href="http://sitebar.org/">SiteBar hjemmeside</a> kan du lære mere om hvad SiteBar kan.
_P;

$para['integrator::hint_uninstall'] = <<<_P
Fjerner SiteBar fra Ikon bjælken (se ovenover).
_P;
...
Tillad brugere at oprette ekstra strukturer.
_P;

$para['command::tooltip_approved'] = <<<_P
Du er nu oprettet og du kan fuldtud bruge SiteBar.
_P;

$para['usermanager::signup_info'] = <<<_P
Brugeren %s tilmeldte sig til din SiteBar installation klokken %s.
_P;
