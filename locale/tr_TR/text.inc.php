...
$text['Change Member Status'] = <<<_P
Üye Durumunu Değiştir
_P;

$text['Change Invitee Status'] = <<<_P
Davet Edilenin Durumunu Değiştir
_P;
...
Ayarlanabilir Web Arama Motoruna İzin Ver
_P;

$text['Allow Info Mail'] = <<<_P
Bilgi E-Mail'ine İzin Ver
_P;
...
$text['Open Links in New Window'] = <<<_P
Linkleri Yeni Pencerede Aç
_P;
...
Pop-up Penceresinin Değişkenleri
_P;
...
Silinme hakkında E-mail gönder
_P;
...
İnternet Arama Motorunu Kullan
_P;
...
İnternet Arama Motoru Simgesi
_P;

$text['Web Search Engine URL'] = <<<_P
İnternet Arama Motoru URL'si
_P;
...
Grup sahibine mesaj at
_P;

$text['To (Just Label)'] = <<<_P
Kime (Sadece Başlık için)
_P;
...
%s adlı Grubun Üyeleri
_P;

$text['Moderator of %s Group'] = <<<_P
%s Grubunun Moderatörü
_P;

$text['Moderators of %s Group'] = <<<_P
%s Grubunun Moderatörleri
_P;
...
Sitebar kurulumundaki mesajlar, 
_P;
...
%s dosyası açılamadı. HTTP sunucunuzda inc klasörüne yazma yetkiniz olduğundan emin olun.
_P;

$text['Cannot send verification email!'] = <<<_P
Doğrulama email'i gönderilemiyor!
_P;
...
Grupadı şu karakterleri içeremez: [%s]
_P;
...
Simge boyutu %s en fazla boyut olan %s'yi aşıyor.
_P;
...
Diğer üyeleri silebilen, davet edebilen veya destekçi olarak işaretleyebilen üye.
_P;

$text['Member that can share their folders with this group.'] = <<<_P
Klasörlerini bu grupla paylaşabilecek üye
_P;
...
Son işlemleri kaydedin ve SiteBar geliştiricileri ile iletişime geçin!
_P;

$text['Please override designedBy for your custom skins!'] = <<<_P
Lütfen kendi kabuklarınız(skin) için designedBy yazısını değiştiriniz!
_P;
...
Email adresi zaten kullanılmakta, lütfen başka bir email adresi girin!
_P;

$text['This operation would lead to broken database.'] = <<<_P
Bu işlem bozuk bir veritabanına yol açabilir.
_P;

$text['This user does not exist!'] = <<<_P
Böyle bir kullanıcı bulunmamaktadır!
_P;

$text['This username is already used, select another one!'] = <<<_P
Bu kullanıcı adı zaten kullanılmakta başka bir kullanıcı adı belirleyin!
_P;

$text['This username is already used. Did you forget your password?'] = <<<_P
Bu kullanıcı adı zaten kullanılmakta. Şifrenizi mi unuttunuz?
_P;
...
$text['User "%s" cannot be approved because user email "%s" has not been verified!'] = <<<_P
%s adlı kullanıcı kabul edilemez çünkü e-mail adresi ( %s ) doğrulanmadı!
_P;

$text['User %s approved.'] = <<<_P
%s adlı kullanıcı onaylandı.
_P;

$text['User %s has already been approved!'] = <<<_P
%s adlı kullanıcı daha önceden onaylanmıştı!
_P;
...
%s adlı kullanıcı bulunmamaktadır!
_P;
...
Kullanıcı adı şu karakterleri içeremez: [%s]
_P;
...
XML hatası: %s %d satırında %d sütununda
_P;

$text['You have %d new messages!'] = <<<_P
%d yeni mesajınız var!
_P;
...
%s email adresi doğrulandı!
_P;

$text['Imported %s link(s) into %s folder(s) from the bookmark file.'] = <<<_P
%s bağlantıları bağlantı dosyasından %s klasörüne alındı.
_P;
