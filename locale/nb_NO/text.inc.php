...
Filtrer grupper nar mer enn
_P;

$text['Filter Users When More Than'] = <<<_P
Filtrer brukere nar fler enn
_P;
...
$text['Modify User Membership'] = <<<_P
Modifiser brukermedlemsskap
_P;

$text['Modify User Settings'] = <<<_P
Modifiser brukerinnstillinger
_P;
...
Brukere som venter pa verifisering
_P;

$text['Pending Unverified Users'] = <<<_P
Ikke-verifiserte brukere pa vent
_P;
...
Send melding til medlemmer
_P;

$text['Send Message to Moderators'] = <<<_P
Send melding til moderatorer
_P;
...
Tillat tilpasset websokemaskin
_P;
...
Tillat a legge til deg selv
_P;

$text['Allow Sign Up'] = <<<_P
Tillat a registrere deg selv
_P;
...
$text['Cannot Leave Group'] = <<<_P
Kan ikke forlate gruppe
_P;
...
$text['Join on Sign Up'] = <<<_P
Bli med eller registrer deg
_P;

$text['Keep Current URL'] = <<<_P
Behold navarende URL
_P;
...
Begrens lengden pa beskrivelser
_P;
...
Vis sokemaskinresultater inline
_P;
...
Bruk utgaende forbindelse
_P;

$text['Use SiteBar Tooltips'] = <<<_P
Bruk SiteBar Verktoytips
_P;
...
Brukere kan opprette trar
_P;

$text['Users Can Delete Trees'] = <<<_P
Brukere kan slette trar
_P;

$text['Users Must Be Approved'] = <<<_P
Brukere ma godkjennes
_P;

$text['Users Must Verify E-mail'] = <<<_P
Brukere ma verifisere epost
_P;
...
Prover igjen i lopet av %d timer.
_P;
...
Melding fra SiteBar installasjon ved
_P;
...
Kan ikke slette bruker fordi brukeren er den eneste moderator i folgende gruppe(r): %s!
_P;

$text['Cannot download %s using https, will try http!'] = <<<_P
Kan ikke nedlaste %s ved bruk av https, prover http!
_P;
...
Kommandoen "%s" er ikke tilgjengelig for oyeblikket!
_P;
...
Standarddomenet ma ikke inneholde et @-tegn
_P;

$text['Description too long for inplace editing, please use export feature!'] = <<<_P
Beskrivelsen var for lang for redigering pa stedet, vennligst bruk eksport-funksjonen!
_P;
...
HEAD er ikke stottet, prover GET!
_P;
...
Ikon-storrelsen %s er over maksimalstorrelsen %s!
_P;
...
Lenken finnes allerede i malmappen!
_P;
...
Ingen bruker med denne epostadressen finne pa denne tjeneren!
_P;

$text['No users are pending!'] = <<<_P
Ingen brukere er pa vent!
_P;
...
Notenummer %s har ACL-oppforing, men eksisterer ikke!
_P;

$text['One of the two fields must be filled!'] = <<<_P
En av de to feltene ma fylles inn!
_P;
...
Klikk pa "%s"-kommandoen og fullfor verifikasjonsprosedyren.
_P;

$text['Please click on the link presented below to send the email!'] = <<<_P
Klikk pa lenka nedenfor for a sende epost!
_P;
...
Rydd mappe for a fjerne den permanent!
_P;

$text['Favicon not found! Trying default favicon location %s.'] = <<<_P
Snarveisikon ikke funnet! Prov standard plassering %s for favikoner.
_P;

$text['The description length exceeds maximum length of %s bytes!'] = <<<_P
Lengden pa beskrivelsen overgar maks-lengden pa %s byte!
_P;

$text['The e-mail %s does not look correctly!'] = <<<_P
Epostadresen %s ser ikke ut til a vare korrekt!
_P;
...
Det er ingen skjulte trar!
_P;

$text['There is no content to be deleted!'] = <<<_P
Det er ikke noe innhold a slette!
_P;

$text['There is nothing to be undeleted!'] = <<<_P
Det er ingen ting a gjenopprette!
_P;

$text['This email is already used. Try to login using your email address!'] = <<<_P
Denne epostadressen er allerede i bruk, Prov a logge inn med din epostadresse!
_P;
...
Denne SiteBar-tjenere krever at din epostadresse ma godkjennes for du kan bruke ende av dens funksjoner.
_P;
...
Bruk kommandoen"%s" for a slette egen konto!
_P;

$text['User "%s" did not verify own email "%s" yet!'] = <<<_P
Bruker "%s" har ikke verifisert sin egen epostadresse "%s" enna?!
_P;

$text['User %s has already been approved!'] = <<<_P
Bruker %s har allerede blitt godkjent!
_P;

$text['User %s approved.'] = <<<_P
Bruker %s er godkjent!
_P;
...
Det finnes ingen bruker med brukernavn "%s"!
_P;
...
Du ma sette pa stotte for cookies i nettleseren din for a logge inn eller registrere deg!
_P;
...
Det ble motatt et ugyldig eller utgatt token. Alle ventende token ble slettet
_P;

$text['Link has been added.<p>You must reload your SiteBar in order to see added link!'] = <<<_P
Lenka har blitt lagt til.<p>Du ma oppfriske din SiteBar for a se den tillagte lenka!
_P;
...
Din konto blir aktivert sasnart en administrator godkjenner den.
_P;
...
Det er ingen konverteringsmotor tilgjengelig for a konvertere fra tegnsettet %s!
_P;
